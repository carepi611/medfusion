import os.path
import sys
sys.path.append(os.path.dirname('/home/zhouchaoyang/pycharmProject/medfusion/medical_diffusion'))
...
if __name__ == "__main__":
    ...
    ds_2 = MSIvsMSS_2_Dataset(  # 512x512
        ...
        augment_horizontal_flip=True,
        augment_vertical_flip=True,
        path_root='/home/zhouchaoyang/pycharmProject/medfusion/datasets/CRCDX/TRAIN'
    ...
    # SimpleDataModule 返还的是一个 dataloader
    dm = SimpleDataModule(
        ds_train=ds_2,
        batch_size=4,
        # num_workers=0,
    ...
    early_stopping = EarlyStopping(
        ...
        patience=30,  # number of checks with no improvement3
        mode=min_max
    )
    checkpointing = ModelCheckpoint(
        dirpath=str(path_run_dir),  # dir_path
        monitor=to_monitor,
    ...
    # ---------------- Execute Training ----------------
    trainer.fit(model, datamodule=dm, ckpt_path='/home/zhouchaoyang/pycharmProject/medfusion/scripts/runs/2023_06_14_154056/last.ckpt')
